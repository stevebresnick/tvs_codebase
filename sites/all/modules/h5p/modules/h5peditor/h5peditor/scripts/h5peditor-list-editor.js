  ...
  function ListEditor(list) {
    ...
    self.addItem = function (item) {
      ...
      if (item instanceof H5PEditor.Group) {
        ...
        // Move label
        $item.children('.field').children('.title').remove();
    ...
    self.appendTo = function ($container) {
      ...
      $horizRule.appendTo($container);

      if (this.entity.toLowerCase() === "hotspot") {
        $button[0].id="addNewHotspot";
        $button.hide();
      }
      else if (this.entity.toLowerCase() === "statements") {
        $button[0].id="addNewStatement";
        $button.hide();
      }
      else if (this.entity.toLowerCase() === "question") {
        $button[0].id="addNewQuestion";
        $button.hide();
      }
      else if (this.entity.toLowerCase() === "text block") {
        $button[0].id="addNewTextBlock";
        $button.hide();
      }
    };
