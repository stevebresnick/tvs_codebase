...
ns.Group.prototype.appendTo = function ($wrapper) {
  ...
  var styles = "";
  if (this.field.hide) {styles="display:none;"}
    
  var classes = "field group";
  var titleClass = "stdTitle";
  var contentClasses = "content";
  if (this.field.expandable) {
      classes += " common collapsed";
      contentClasses += " fields";
      titleClass = "title";
  }
...
ns.Group.prototype.expand = function () {
  ...
  this.$group.removeClass('collapsed');
...
ns.Group.prototype.setSummary = function (summary) {
  var summaryText = this.field.label;

  this.$group.children('.title').html(summaryText);
  this.$group.children('.stdTitle').html(summaryText);
};
